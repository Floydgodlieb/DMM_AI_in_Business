...
**Source diversity rule.** For every claim about who leads or who owns what, we hold at least one source from each of the three regions' perspectives, or we say we could not find one. This is the lesson of assignment 1 written into the method.
...
**Appendix C — search log** [attach the log described in section 2]
